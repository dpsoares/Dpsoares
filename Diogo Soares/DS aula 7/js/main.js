...
var bookDictionary1 = {name:"Nome do Vento", 
	...
	imagpath:"capa.jpg",
	href:"https://pt.wikipedia.org/wiki/O_Nome_do_Vento",
	linkwiki:"https://pt.wikipedia.org/wiki/O_Nome_do_Vento", 
	linkFoursquare:"",
	linkZomato:"", 
	linkOutros:""};

var bookDictionary2 = {name:"As mentiras de locke lamora", price:"19,29", sinopse:"As Mentiras de Locke Lamora é um livro de fantasia de 2006 escrito por Scott Lynch, o primeiro livro da série Os Nobres Vigaristas. Vigaristas de elite que chamam a si próprios de Os Nobres Vigaristas roubam dos ricos na cidade de Camorr, uma cidade baseada na Veneza medieval, mas em um mundo sem nome. <br> Duas histórias se entrelaçam: no presente, os Nobres Vigaristas lutam contra o misterioso Rei Cinza.", imagpath:"capaLL.jpg",linkwiki:"https://pt.wikipedia.org/wiki/O_Nome_do_Vento", linkFoursquare:"",linkZomato:"", linkOutros:""};

var bookDictionary3 = {name:"", price:"19,29", sinopse:"O Império Final - Saga Mistborn - Nascida das Brumas Vol 1 Num mundo onde as cinzas caem do céu e as brumas dominam a noite, o povo dos Skaa vive escravizado e na absoluta miséria.Durante mais de mil anos, o Senhor Soberano governou com um poder divino inquestionável e pela força do terror. <br> Mas quando a esperança parecia perdida, um sobrevivente de nome Kelsier escapa do mais terrível cativeiro graças à estranha magia dos metais – a Alomância.", imagpath:"capaMB.jpg",linkwiki:"https://pt.wikipedia.org/wiki/O_Nome_do_Vento", linkFoursquare:"",linkZomato:"", linkOutros:""};
...
function LoadDataWithHTML(){
	var HTMLtoInsert = `
		<div class="Books col-sm-4 col-sm-offset-4">
          ...
          <br>
          <div class="clearfix"> 
            <a class="pull-left"; target="_blank">Wikipédia</a> 
            <a href="https://www.zomato.com/pt/grande-lisboa" class="pull-right"; target="_blank">Zomato</a> 
          </div>
          <div class="clearfix"> 
            <a href="https://pt.foursquare.com/" class="pull-left" target="_blank">Foursquare</a>
            <a href="http://www.slbenfica.pt/" class="pull-right"; target="_blank">Outros</a>
          </div>
        </div>`;
...
// function loadData (){
//  	$book1html = $('.Books').eq(0); 
//  	// $item = $('#capa1');
//  	$("h1",$book1html).text(bookDictionary1.name); 
//  	$("h3",$book1html).text(bookDictionary1.price); 
//  	$("p",$book1html).text(bookDictionary1.sinopse);
//  	$("img",$book1html).attr("src",bookDictionary1.imagpath);
//  };
